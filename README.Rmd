...
This R package is forked from Stefanie Schneider's original viafr package at
...
We have a [Contributor Code of Conduct](https://github.com/kijinosu/rviaf/blob/master/CODE_OF_CONDUCT.md).
