...
#'
#' @rdname stylesheets
#' @details 'vc_names' produces an xml file with multiple rows. The 'preferred'
...
#' vc_titles XSL stylesheet extracts titles data from a VIAF cluster
#' viaf.xml record
#'
#' @docType data
#' @keywords xsl
...
#' vp21_jointpersons XSL stylesheet extracts links data
#' from a processed source record that is in marc21.xml
#'
#' @docType data
#' @keywords xsl
#' @name vp21_jointpersons
#'
#' @rdname stylesheets
#' @details 'vp21_jointpersons' produces an xml file with multiple rows.
#'
"vp21_jointpersons"
